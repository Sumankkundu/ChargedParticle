...
int nbinsx0[nvar][nHLTmx]={{},{},{},
                   {25,28,28,30,31,31,33,36},//3
                   {},{},{},{},{},
                   {23,26,28,29,28,31,30,34},//9
                   {},{},{},{},{},
                   {7,11,14,15,17,20,17,23},//15
                   {},{},
                   {19,20,23,24,26,26,25,30},//18
                   {},{},{},{},{},
                   {19,21,23,26,28,28,26,29},//24
                   {},{},{},{},{},{},{}};

//For Jet Particles
int nbinsx1[nvar][nHLTmx]={{},{},{},
                   {25,27,29,34,29,20,21,19},//3
                   {},{},{},{},{},
                   {23,22,24,30,26,32,25,19},//9
                   {},{},{},{},{},
                   {10,11,11,12,10,12,12,12},//15
                   {},{},
                   {24,27,32,31,25,25,21,18},//18
                   {},{},{},{},{},
                   {16,16,17,18,19,19,18,16},//24
                   {},{},{},{},{},{},{}};
*/
int nbinsx0[nvar][nHLTmx]={{},{},{},
...
double leadingPtThreshold[njetptmn+1] ={83, 109, 180, 249, 319, 388, 477, 580, 3000.0}; //Fit Value dijet trigger
...
//    if (npu<0) return; //GMA
  ...
  if (ak4PFJets.isValid()) { 
    for(unsigned ijet = 0; ijet != ak4PFJets->size(); ijet++) {
      ...
      resolution = JME::JetResolution("Autumn18_V7b_DATA_PtResolution_AK4PFchs.txt");
    ...
    res_sf = JME::JetResolutionScaleFactor("Autumn18_V7b_DATA_SF_AK4PFchs.txt");
...
// JetCorrectorParameters *p = new JetCorrectorParameters("Autumn18_RunA_V19_DATA_UncertaintySources_AK4PFchs.txt", name);    
// JetCorrectorParameters *p = new JetCorrectorParameters("Autumn18_RunB_V19_DATA_UncertaintySources_AK4PFchs.txt", name);    
// JetCorrectorParameters *p = new JetCorrectorParameters("Autumn18_RunC_V19_DATA_UncertaintySources_AK4PFchs.txt", name);    
 JetCorrectorParameters *p = new JetCorrectorParameters("Autumn18_RunD_V19_DATA_UncertaintySources_AK4PFchs.txt", name);    
