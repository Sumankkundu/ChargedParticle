  ...
  for (int ityp=0; ityp<ntype; ityp++) {
	...
	for (int ij=0; ij<nvar; ij++) {
	  if (isItUsed(ij)) { 
	   ...
	   //   h_recoevtvar[ityp][ipt][iet][ij] = fs->make<TH1F>(name, title, nbinsx[ij], -eendx[ityp][ij][ipt], -estartx[ityp][ij][ipt]);
	    ...
	    for (int ix=1; ix<njecmx; ix++) {
	      ...
	      h_recoevtvarjec[ityp][ipt][iet][ij][ix] = fs->make<TH1F>(name, title,  (ityp==0) ? rnbinsx0[ij][ipt] : rnbinsx1[ij][ipt] , (ityp==0) ? rbinrngs0[ij][ipt] : rbinrngs1[ij][ipt]);
...
//	    h_genevtvar[ityp][ipt][iet][ij] = fs->make<TH1F>(name, title, (ityp==0) ? nbinsx0[ij] : ((ityp==1 || ityp==3) ? nbinsx1[ij] : nbinsx2[ij]), (ityp==0) ? binrngs0[ij] : ((ityp==1 || ityp==3) ? binrngs1[ij] : binrngs2[ij]));
         // h_genevtvar[ityp][ipt][iet][ij] = fs->make<TH1F>(name, title, nbinsxgen[ij], -endx[ij], -startx[ij]);
          ...
          //  h_genevtvar[ityp][ipt][iet][ij] = fs->make<TH1F>(name, title, nbinsx[ij],-eendx[ityp][ij][ipt], -estartx[ityp][ij][ipt]);
	  ...
	  //  h_2devtvar[ityp][ipt][iet][ij] = fs->make<TH2F>(name, title, nbinsx[ij],-eendx[ityp][ij][ipt], -estartx[ityp][ij][ipt], nbinsx[ij],-eendx[ityp][ij][ipt], -estartx[ityp][ij][ipt]);
