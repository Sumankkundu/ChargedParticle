...
TString cmsText     = "CMS";
float cmsTextFont   = 80;  // default is helvetic-bold

bool writeExtraText = true;
TString extraText   = /*"";"Private work"; */"Preliminary";
float extraTextFont = 80;  // default is helvetica-italics
...
float extraOverCmsTextSize  = 1.0;
...
TString lumi_sqrtS = " 41.53  fb^{-1}"; //UL 17 data 
//TString lumi_sqrtS = "59.74 fb^{-1}"; //UL 18 data 
